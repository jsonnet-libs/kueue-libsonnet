{
  ...
  '#':: d.pkg(name='workload', url='', help='"Workload is the Schema for the workloads API"'),
      ...
      template: {
        ...
        spec: {
          ...
          resources: {
            ...
            '#withClaims':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis field depends on the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."', args=[d.arg(name='claims', type=d.T.array)]),
            withClaims(claims): { template+: { spec+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } } },
            '#withClaimsMixin':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis field depends on the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
            withClaimsMixin(claims): { template+: { spec+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } } },
            '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
            withLimits(limits): { template+: { spec+: { resources+: { limits: limits } } } },
            '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
            withLimitsMixin(limits): { template+: { spec+: { resources+: { limits+: limits } } } },
            '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required.\\nIf Requests is omitted for a container, it defaults to Limits if that is explicitly specified,\\notherwise to an implementation-defined value. Requests cannot exceed Limits.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
            withRequests(requests): { template+: { spec+: { resources+: { requests: requests } } } },
            '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required.\\nIf Requests is omitted for a container, it defaults to Limits if that is explicitly specified,\\notherwise to an implementation-defined value. Requests cannot exceed Limits.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
            withRequestsMixin(requests): { template+: { spec+: { resources+: { requests+: requests } } } },
          },
          ...
          securityContext: {
            ...
            appArmorProfile: {
              '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
              withLocalhostProfile(localhostProfile): { template+: { spec+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } },
              '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
              withType(type): { template+: { spec+: { securityContext+: { appArmorProfile+: { type: type } } } } },
            },
            ...
            withSeLinuxChangePolicy(seLinuxChangePolicy): { template+: { spec+: { securityContext+: { seLinuxChangePolicy: seLinuxChangePolicy } } } },
            ...
            withSupplementalGroupsPolicy(supplementalGroupsPolicy): { template+: { spec+: { securityContext+: { supplementalGroupsPolicy: supplementalGroupsPolicy } } } },
          ...
          withHostnameOverride(hostnameOverride): { template+: { spec+: { hostnameOverride: hostnameOverride } } },
          ...
          withResourceClaims(resourceClaims): { template+: { spec+: { resourceClaims: if std.isArray(v=resourceClaims) then resourceClaims else [resourceClaims] } } },
          ...
          withResourceClaimsMixin(resourceClaims): { template+: { spec+: { resourceClaims+: if std.isArray(v=resourceClaims) then resourceClaims else [resourceClaims] } } },
          ...
          withSchedulingGates(schedulingGates): { template+: { spec+: { schedulingGates: if std.isArray(v=schedulingGates) then schedulingGates else [schedulingGates] } } },
          ...
          withSchedulingGatesMixin(schedulingGates): { template+: { spec+: { schedulingGates+: if std.isArray(v=schedulingGates) then schedulingGates else [schedulingGates] } } },
          ...
          workloadRef: {
            ...
            withName(name): { template+: { spec+: { workloadRef+: { name: name } } } },
            ...
            withPodGroup(podGroup): { template+: { spec+: { workloadRef+: { podGroup: podGroup } } } },
            ...
            withPodGroupReplicaKey(podGroupReplicaKey): { template+: { spec+: { workloadRef+: { podGroupReplicaKey: podGroupReplicaKey } } } },
          },
        },
      },
      '#topologyRequest':: d.obj(help='"topologyRequest defines the topology request for the PodSet."'),
      topologyRequest: {
        '#podsetSliceRequiredTopologyConstraints':: d.obj(help='"podsetSliceRequiredTopologyConstraints defines all layers of slice\\ntopology constraints. Each entry specifies a topology level and slice\\nsize, from the outermost (coarsest) to the innermost (finest) layer.\\nAt most 3 layers are supported.\\nThis field is mutually exclusive with podSetSliceRequiredTopology and\\npodSetSliceSize.\\n\\nThis annotation is alpha-level for the TASMultiLayerTopology feature gate."'),
        podsetSliceRequiredTopologyConstraints: {
          '#withSize':: d.fn(help='"size indicates the number of pods in each group at this slice layer."', args=[d.arg(name='size', type=d.T.integer)]),
          withSize(size): { size: size },
          '#withTopology':: d.fn(help='"topology indicates the topology level required for this slice layer."', args=[d.arg(name='topology', type=d.T.string)]),
          withTopology(topology): { topology: topology },
        },
        '#withPodIndexLabel':: d.fn(help='"podIndexLabel indicates the name of the label indexing the pods.\\nFor example, in the context of\\n- kubernetes job this is: kubernetes.io/job-completion-index\\n- JobSet: kubernetes.io/job-completion-index (inherited from Job)\\n- Kubeflow: training.kubeflow.org/replica-index\\n\\tThis is limited to 317 characters."', args=[d.arg(name='podIndexLabel', type=d.T.string)]),
        withPodIndexLabel(podIndexLabel): { topologyRequest+: { podIndexLabel: podIndexLabel } },
        '#withPodSetGroupName':: d.fn(help='"podSetGroupName indicates the name of the group of PodSets to which this PodSet belongs to.\\nPodSets with the same `PodSetGroupName` should be assigned the same ResourceFlavor"', args=[d.arg(name='podSetGroupName', type=d.T.string)]),
        withPodSetGroupName(podSetGroupName): { topologyRequest+: { podSetGroupName: podSetGroupName } },
        '#withPodSetSliceRequiredTopology':: d.fn(help='"podSetSliceRequiredTopology indicates the topology level required by the PodSet slice, as\\nindicated by the `kueue.x-k8s.io/podset-slice-required-topology` annotation.\\n\\nThis is limited to 63"', args=[d.arg(name='podSetSliceRequiredTopology', type=d.T.string)]),
        withPodSetSliceRequiredTopology(podSetSliceRequiredTopology): { topologyRequest+: { podSetSliceRequiredTopology: podSetSliceRequiredTopology } },
        '#withPodSetSliceSize':: d.fn(help='"podSetSliceSize indicates the size of a subgroup of pods in a PodSet for which\\nKueue finds a requested topology domain on a level defined\\nin `kueue.x-k8s.io/podset-slice-required-topology` annotation."', args=[d.arg(name='podSetSliceSize', type=d.T.integer)]),
        withPodSetSliceSize(podSetSliceSize): { topologyRequest+: { podSetSliceSize: podSetSliceSize } },
        '#withPodsetSliceRequiredTopologyConstraints':: d.fn(help='"podsetSliceRequiredTopologyConstraints defines all layers of slice\\ntopology constraints. Each entry specifies a topology level and slice\\nsize, from the outermost (coarsest) to the innermost (finest) layer.\\nAt most 3 layers are supported.\\nThis field is mutually exclusive with podSetSliceRequiredTopology and\\npodSetSliceSize.\\n\\nThis annotation is alpha-level for the TASMultiLayerTopology feature gate."', args=[d.arg(name='podsetSliceRequiredTopologyConstraints', type=d.T.array)]),
        withPodsetSliceRequiredTopologyConstraints(podsetSliceRequiredTopologyConstraints): { topologyRequest+: { podsetSliceRequiredTopologyConstraints: if std.isArray(v=podsetSliceRequiredTopologyConstraints) then podsetSliceRequiredTopologyConstraints else [podsetSliceRequiredTopologyConstraints] } },
        '#withPodsetSliceRequiredTopologyConstraintsMixin':: d.fn(help='"podsetSliceRequiredTopologyConstraints defines all layers of slice\\ntopology constraints. Each entry specifies a topology level and slice\\nsize, from the outermost (coarsest) to the innermost (finest) layer.\\nAt most 3 layers are supported.\\nThis field is mutually exclusive with podSetSliceRequiredTopology and\\npodSetSliceSize.\\n\\nThis annotation is alpha-level for the TASMultiLayerTopology feature gate."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='podsetSliceRequiredTopologyConstraints', type=d.T.array)]),
        withPodsetSliceRequiredTopologyConstraintsMixin(podsetSliceRequiredTopologyConstraints): { topologyRequest+: { podsetSliceRequiredTopologyConstraints+: if std.isArray(v=podsetSliceRequiredTopologyConstraints) then podsetSliceRequiredTopologyConstraints else [podsetSliceRequiredTopologyConstraints] } },
        '#withPreferred':: d.fn(help='"preferred indicates the topology level preferred by the PodSet, as\\nindicated by the `kueue.x-k8s.io/podset-preferred-topology` PodSet\\nannotation.\\nThis is limited to 63 characters."', args=[d.arg(name='preferred', type=d.T.string)]),
        withPreferred(preferred): { topologyRequest+: { preferred: preferred } },
        '#withRequired':: d.fn(help='"required indicates the topology level required by the PodSet, as\\nindicated by the `kueue.x-k8s.io/podset-required-topology` PodSet\\nannotation.\\nThis is limited to 63 characters."', args=[d.arg(name='required', type=d.T.string)]),
        withRequired(required): { topologyRequest+: { required: required } },
        '#withSubGroupCount':: d.fn(help='"subGroupCount indicates the count of replicated Jobs (groups) within a PodSet.\\nFor example, in the context of JobSet this value is read from jobset.sigs.k8s.io/replicatedjob-replicas."', args=[d.arg(name='subGroupCount', type=d.T.integer)]),
        withSubGroupCount(subGroupCount): { topologyRequest+: { subGroupCount: subGroupCount } },
        '#withSubGroupIndexLabel':: d.fn(help='"subGroupIndexLabel indicates the name of the label indexing the instances of replicated Jobs (groups)\\nwithin a PodSet. For example, in the context of JobSet this is jobset.sigs.k8s.io/job-index.\\n\\tThis is limited to 317 characters."', args=[d.arg(name='subGroupIndexLabel', type=d.T.string)]),
        withSubGroupIndexLabel(subGroupIndexLabel): { topologyRequest+: { subGroupIndexLabel: subGroupIndexLabel } },
        '#withUnconstrained':: d.fn(help='"unconstrained indicates that Kueue has the freedom to schedule the PodSet within\\nthe entire available capacity, without constraints on the compactness of the placement.\\nThis is indicated by the `kueue.x-k8s.io/podset-unconstrained-topology` PodSet annotation."', args=[d.arg(name='unconstrained', type=d.T.boolean)]),
        withUnconstrained(unconstrained): { topologyRequest+: { unconstrained: unconstrained } },
      },
      '#withCount':: d.fn(help='"count is the number of pods for the spec."', args=[d.arg(name='count', type=d.T.integer)]),
      withCount(count): { count: count },
      '#withMinCount':: d.fn(help='"minCount is the minimum number of pods for the spec acceptable\\nif the workload supports partial admission.\\n\\nIf not provided, partial admission for the current PodSet is not\\nenabled.\\n\\nOnly one podSet within the workload can use this.\\n\\nThis is an alpha field and requires enabling PartialAdmission feature gate."', args=[d.arg(name='minCount', type=d.T.integer)]),
      withMinCount(minCount): { minCount: minCount },
      '#withName':: d.fn(help='"name is the PodSet name."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    },
    '#preemptionGates':: d.obj(help='"preemptionGates is a list of gates governing whether the workload\\ncan trigger preemptions.\\nThe gates are closed by default."'),
    preemptionGates: {
      '#withName':: d.fn(help='"name identifies the preemption gate."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    },
    '#priorityClassRef':: d.obj(help="\"priorityClassRef references a PriorityClass object that defines the workload's priority.\""),
    priorityClassRef: {
      '#withGroup':: d.fn(help='"group is the API group of the PriorityClass object.\\nUse \\"kueue.x-k8s.io\\" for WorkloadPriorityClass.\\nUse \\"scheduling.k8s.io\\" for Pod PriorityClass."', args=[d.arg(name='group', type=d.T.string)]),
      withGroup(group): { spec+: { priorityClassRef+: { group: group } } },
      '#withKind':: d.fn(help='"kind is the kind of the PriorityClass object."', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { priorityClassRef+: { kind: kind } } },
      '#withName':: d.fn(help="\"name is the name of the PriorityClass the Workload is associated with.\\nIf specified, indicates the workload's priority.\\n\\\"system-node-critical\\\" and \\\"system-cluster-critical\\\" are two special\\nkeywords which indicate the highest priorities with the former being\\nthe highest priority. Any other name must be defined by creating a\\nPriorityClass object with that name. If not specified, the workload\\npriority will be default or zero if there is no default.\"", args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { priorityClassRef+: { name: name } } },
    },
    '#withActive':: d.fn(help="\"active determines if a workload can be admitted into a queue.\\nChanging active from true to false will evict any running workloads.\\nPossible values are:\\n\\n  - false: indicates that a workload should never be admitted and evicts running workloads\\n  - true: indicates that a workload can be evaluated for admission into it's respective queue.\\n\\nDefaults to true\"", args=[d.arg(name='active', type=d.T.boolean)]),
    withActive(active): { spec+: { active: active } },
    '#withMaximumExecutionTimeSeconds':: d.fn(help="\"maximumExecutionTimeSeconds if provided, determines the maximum time, in seconds,\\nthe workload can be admitted before it's automatically deactivated.\\n\\nIf unspecified, no execution time limit is enforced on the Workload.\"", args=[d.arg(name='maximumExecutionTimeSeconds', type=d.T.integer)]),
    withMaximumExecutionTimeSeconds(maximumExecutionTimeSeconds): { spec+: { maximumExecutionTimeSeconds: maximumExecutionTimeSeconds } },
    '#withPodSets':: d.fn(help='"podSets is a list of sets of homogeneous pods, each described by a Pod spec\\nand a count.\\nThere must be at least one element and at most 8.\\npodSets cannot be changed."', args=[d.arg(name='podSets', type=d.T.array)]),
    withPodSets(podSets): { spec+: { podSets: if std.isArray(v=podSets) then podSets else [podSets] } },
    '#withPodSetsMixin':: d.fn(help='"podSets is a list of sets of homogeneous pods, each described by a Pod spec\\nand a count.\\nThere must be at least one element and at most 8.\\npodSets cannot be changed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='podSets', type=d.T.array)]),
    withPodSetsMixin(podSets): { spec+: { podSets+: if std.isArray(v=podSets) then podSets else [podSets] } },
    '#withPreemptionGates':: d.fn(help='"preemptionGates is a list of gates governing whether the workload\\ncan trigger preemptions.\\nThe gates are closed by default."', args=[d.arg(name='preemptionGates', type=d.T.array)]),
    withPreemptionGates(preemptionGates): { spec+: { preemptionGates: if std.isArray(v=preemptionGates) then preemptionGates else [preemptionGates] } },
    '#withPreemptionGatesMixin':: d.fn(help='"preemptionGates is a list of gates governing whether the workload\\ncan trigger preemptions.\\nThe gates are closed by default."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preemptionGates', type=d.T.array)]),
    withPreemptionGatesMixin(preemptionGates): { spec+: { preemptionGates+: if std.isArray(v=preemptionGates) then preemptionGates else [preemptionGates] } },
    '#withPriority':: d.fn(help='"priority determines the order of access to the resources managed by the\\nClusterQueue where the workload is queued.\\nThe priority value is populated from the referenced PriorityClass (via priorityClassRef).\\nThe higher the value, the higher the priority.\\nIf priorityClassRef is specified, priority must not be null."', args=[d.arg(name='priority', type=d.T.integer)]),
    withPriority(priority): { spec+: { priority: priority } },
    '#withQueueName':: d.fn(help='"queueName is the name of the LocalQueue the Workload is associated with.\\nqueueName cannot be changed while .status.admission is not null."', args=[d.arg(name='queueName', type=d.T.string)]),

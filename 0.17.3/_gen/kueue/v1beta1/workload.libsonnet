  ...
  spec: {
    ...
    podSets: {
      ...
      topologyRequest: {
        ...
        '#withPodSetSliceRequiredTopology':: d.fn(help='"podSetSliceRequiredTopology indicates the topology level required by the PodSet slice, as\\nindicated by the `kueue.x-k8s.io/podset-slice-required-topology` annotation."', args=[d.arg(name='podSetSliceRequiredTopology', type=d.T.string)]),
        ...
        '#withSubGroupIndexLabel':: d.fn(help='"subGroupIndexLabel indicates the name of the label indexing the instances of replicated Jobs (groups)\\nwithin a PodSet. For example, in the context of JobSet this is jobset.sigs.k8s.io/job-index."', args=[d.arg(name='subGroupIndexLabel', type=d.T.string)]),
    ...
    '#withPriority':: d.fn(help='"priority determines the order of access to the resources managed by the\\nClusterQueue where the workload is queued.\\nThe priority value is populated from PriorityClassName.\\nThe higher the value, the higher the priority.\\nIf priorityClassName is specified, priority must not be null."', args=[d.arg(name='priority', type=d.T.integer)]),
    withPriority(priority): { spec+: { priority: priority } },
    '#withPriorityClassName':: d.fn(help="\"priorityClassName is the name of the PriorityClass the Workload is associated with.\\nIf specified, indicates the workload's priority.\\n\\\"system-node-critical\\\" and \\\"system-cluster-critical\\\" are two special\\nkeywords which indicate the highest priorities with the former being\\nthe highest priority. Any other name must be defined by creating a\\nPriorityClass object with that name. If not specified, the workload\\npriority will be default or zero if there is no default.\"", args=[d.arg(name='priorityClassName', type=d.T.string)]),
    withPriorityClassName(priorityClassName): { spec+: { priorityClassName: priorityClassName } },
    '#withPriorityClassSource':: d.fn(help="\"priorityClassSource determines whether the priorityClass field refers to a pod PriorityClass or kueue.x-k8s.io/workloadpriorityclass.\\nWorkload's PriorityClass can accept the name of a pod priorityClass or a workloadPriorityClass.\\nWhen using pod PriorityClass, a priorityClassSource field has the scheduling.k8s.io/priorityclass value.\"", args=[d.arg(name='priorityClassSource', type=d.T.string)]),
    withPriorityClassSource(priorityClassSource): { spec+: { priorityClassSource: priorityClassSource } },

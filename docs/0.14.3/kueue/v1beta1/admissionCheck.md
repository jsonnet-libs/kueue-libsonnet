---
permalink: /0.14.3/kueue/v1beta1/admissionCheck/
---

# kueue.v1beta1.admissionCheck
...
* [`obj spec`](#obj-spec)
  * [`fn withControllerName(controllerName)`](#fn-specwithcontrollername)
  * [`fn withRetryDelayMinutes(retryDelayMinutes)`](#fn-specwithretrydelayminutes)
...
new returns an instance of AdmissionCheck
...
### fn spec.withRetryDelayMinutes

```ts
withRetryDelayMinutes(retryDelayMinutes)
```

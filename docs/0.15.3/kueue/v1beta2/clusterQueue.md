---
permalink: /0.15.3/kueue/v1beta2/clusterQueue/
---

# kueue.v1beta2.clusterQueue
...
* [`obj spec`](#obj-spec)
  * [`fn withCohortName(cohortName)`](#fn-specwithcohortname)
  ...
  * [`obj spec.flavorFungibility`](#obj-specflavorfungibility)
    * [`fn withPreference(preference)`](#fn-specflavorfungibilitywithpreference)
...
### fn spec.withCohortName

```ts
withCohortName(cohortName)
```
...
### fn spec.flavorFungibility.withPreference

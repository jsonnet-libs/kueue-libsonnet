---
permalink: /0.15.3/kueue/v1beta1/localQueue/
---

# kueue.v1beta1.localQueue
...
* [`obj spec`](#obj-spec)
  * [`fn withClusterQueue(clusterQueue)`](#fn-specwithclusterqueue)
...
new returns an instance of LocalQueue
...
### fn spec.withClusterQueue

```ts
withClusterQueue(clusterQueue)
```
